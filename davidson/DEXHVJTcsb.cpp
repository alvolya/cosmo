...
#define CSTATUS
#define FSTATUS
#include <xsm/DEXHVcsb.cxx>
#include <xsm/XSHLJT.cxx>

/*-----------MAIN---------------------------------------*/
int main (int argc, char** argv){
av::argparser args(argc,argv);
args.SetDescription("Davidson or eigen diagonalization of Virtual Hamiltonian (generated on fly). CSB-matrix format, followed by spin analysis");
